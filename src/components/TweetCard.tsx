...
export function TweetCard({ tweets }: TweetCardProps) {
  ...
  return (
    <div className="mt-8 md:mt-12 pt-4 md:pt-8 border-t border-border">
      ...
      <div className="grid gap-3 md:gap-4 sm:grid-cols-2 max-w-3xl">
        {tweets.map((tweet, i) => (
          <div
            key={i}
            className="border border-border bg-card/30 rounded-xl p-3 md:p-4 hover:bg-card/50 transition-colors"
          >
            {/* Header */}
            <div className="flex items-start gap-2 md:gap-3 mb-2 md:mb-3">
              ...
              <svg className="w-4 h-4 md:w-5 md:h-5 text-muted-foreground shrink-0" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </div>

            {/* Content */}
            <p className="text-xs md:text-sm leading-relaxed mb-3 md:mb-4 font-serif">
              {tweet.content}
            </p>

            {/* Actions */}
            <div className="flex items-center justify-between text-muted-foreground text-[10px] md:text-xs">
