    ...
    <section className="my-16">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {tweets.map((tweet, i) => (
          <div
            key={i}
            className="border border-border bg-card/50 rounded-lg p-4 hover:bg-card/70 transition-all"
          >
            {/* Header */}
            <div className="flex items-start gap-3 mb-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary/30 to-primary/10 flex items-center justify-center text-lg font-bold shrink-0">
            ...
            {/* Actions */}
            <div className="flex items-center gap-4 text-muted-foreground text-xs pt-3 border-t border-border/50">
