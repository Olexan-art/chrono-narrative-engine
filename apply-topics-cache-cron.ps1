...
Write-Host "`nTopics Cache Optimization Setup`n" -ForegroundColor Cyan
...
Write-Host "[OK] Migration SQL copied to clipboard!`n" -ForegroundColor Green
...
Write-Host "Cron Schedule: Every 6 hours (00:00, 06:00, 12:00, 18:00 UTC)" -ForegroundColor Cyan
Write-Host "Pages cached: /topics + top 30 topic pages" -ForegroundColor Cyan
Write-Host "Cache TTL: 6 hours (matches SSR cache)" -ForegroundColor Cyan
