...
const characters = [
  { id: "darth_vader", name: "Дарт Вейдер", avatar: "🖤", style: "Говорить низьким голосом, використовує темні метафори, часто згадує Силу та долю. Зверхній та владний тон." },
  { id: "kratos", name: "Кратос", avatar: "⚔️", style: "Лаконічний та суровий. Говорить про богів, помсту та силу. Часто роздратований або філософськи налаштований." },
  { id: "deadpool", name: "Дедпул", avatar: "🔴", style: "Саркастичний та самоіронічний. Ламає четверту стіну, жартує про все, використовує сучасний сленг та емодзі." },
  { id: "geralt", name: "Геральт із Рівії", avatar: "🐺", style: "Цинічний реаліст. Говорить 'Хм' та використовує прості, але влучні фрази. Згадує монстрів та контракти." },
  { id: "jon_snow", name: "Джон Сноу", avatar: "🐺", style: "Благородний та похмурий. Говорить про честь, обов'язок та зиму. Часто не знає, що відповісти." },
  { id: "cartman", name: "Ерік Картман", avatar: "🧢", style: "Егоїстичний та маніпулятивний. Перебільшує все, скаржиться, використовує дитячий сленг. Любить їжу." },
  { id: "scorpion", name: "Скорпіон", avatar: "🦂", style: "Говорить про помсту та честь бійця. Часто каже 'Get over here!' та інші бойові фрази. Серйозний." }
];
...
3. ЧОТИРИ іронічних твіти про головну подію`;
    ...
    console.log('Generating multilingual story for:', date);
