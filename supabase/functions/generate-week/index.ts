...
ФОРМАТ ВІДПОВІДІ (JSON):
{
  ...
  "summary": "Короткий опис глави українською",
  "summary_en": "Short chapter description in English",
  "summary_pl": "Krótki opis rozdziału po polsku",
...
Напиши ФІНАЛЬНУ ЧАСТИНУ. ОБОВ'ЯЗКОВО включи ВСІ поля ВСІМА ТРЬОМА МОВАМИ (українською, англійською, польською): назву, опис, монолог, коментар, твіти та чат.`;
    }
