...
{
  "content": "Перша частина тексту (~750 слів). Починай з інтригуючого вступу про цей тиждень. Плавно переходь від однієї події до іншої. Будь лаконічним.",
  "wordCount": 750
}`;
...
Напиши КОМПАКТНУ ПЕРШУ ЧАСТИНУ (~750 слів) синтезу тижня. Це початок — зав'язка та перші події. Уникай повторів та зайвих описів.`;
...
ФОРМАТ ВІДПОВІДІ (JSON):
{
  "content": "Друга частина тексту (~750 слів). Продовжуй розповідь, розвивай теми, додавай нові події тижня.",
  "wordCount": 750
}`;
...
Напиши КОМПАКТНУ ДРУГУ ЧАСТИНУ (~750 слів). Це середина — розвиток подій, кульмінація. Продовжуй стиль попередньої частини. Будь лаконічним.`;
...
2. МОНОЛОГ НЕЗНАЙОМЦЯ — таємничий персонаж, який з'являється наприкінці кожного тижня. 2-3 параграфи.
3. КОМЕНТАР НАРАТОРА — підсумок тижня від імені ШІ-архіватора. 1-2 параграфи.
...
ФОРМАТ ВІДПОВІДІ (JSON):
{
  ...
  "strangerMonologue": "Монолог Незнайомця українською (2-3 параграфи)",
  "strangerMonologue_en": "Stranger's Monologue in English (2-3 paragraphs)",
  "strangerMonologue_pl": "Monolog Nieznajomego po polsku (2-3 akapity)",
  "narratorCommentary": "Коментар Наратора українською (1-2 параграфи)",
  "narratorCommentary_en": "Narrator's Commentary in English (1-2 paragraphs)",
  "narratorCommentary_pl": "Komentarz Narratora po polsku (1-2 akapity)",
