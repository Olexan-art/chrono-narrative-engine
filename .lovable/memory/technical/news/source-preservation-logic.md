...
## UI Component
`OriginalSourceBlock` показує блок з оригінальним текстом (до 2000 символів) відкритим за замовчуванням, з автоматичним розбиттям на параграфи для читабельності та напівпрозорим watermark логотипом джерела (12% opacity, 30% ширини) у нижньому правому куті.
...
## Bulk Scrape Admin Panel
Адмін-панель "Парсинг" (`BulkScrapePanel`) дозволяє масово парсити всі новини без `original_content` з налаштуваннями розміру батчу (1-20), затримки між батчами (100-2000ms) та авто-парсингу при імпорті. Показує статистику та прогрес виконання.
