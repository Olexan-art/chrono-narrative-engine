...
When news items are automatically fetched from RSS feeds, the system can now generate full content (retelling, dialogues, and tweets) in a single automated pipeline. This is controlled by four new settings in the `settings` table:
